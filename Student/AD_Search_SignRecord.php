...
$query_Data = sprintf("SELECT signup_record.Course_ID, signup_record.SignupRecord_ID, signup_record.SignupRecord_Returns, course.Com_Name, course.Unit_Name, course.SeasonCate_Name, course.Season_Code, course.Season_Year, course.Course_Name, course.Course_Start1, course.Course_End1, course.Course_Day1, course.Teacher_UserName, course.CourseStatus_Name, course.Course_Time, course.CourseKind_Name, course.Loc_Name, signup_record.Member_ID FROM signup_record inner join course on signup_record.Course_ID = course.Course_ID where $Member_IDS and ifnull(course.Com_ID,'') Like %s and ifnull(course.Season_Code,'') Like %s and SignupRecord_Returns=0 order by course.Season_Code DESC, SignupRecord_ID asc",GetSQLValueString($colname_Data3, "text"),GetSQLValueString($colname_Data2, "text"));
...
<div>   
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
<div class="SubTitle"><img src="../../Icon/IconEdit.png" width="28" class="middle"> 學員研習紀錄</div>
