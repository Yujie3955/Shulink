...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Edit")) {
	...
	$updateSQL = sprintf("UPDATE season SET  Season_Start=%s, Season_End=%s, Season_SelectStart=%s, Season_SelectEnd=%s, Season_OnsiteStart=%s, Season_OnsiteEnd=%s, Season_GroupStart=%s, Season_GroupEnd=%s, Season_Public=%s, Season_PayStart=%s, Season_PayEnd=%s, Season_Week=%s, Season_Credit=%s, Season_ReturnDay=%s, Season_Benefit=%s, Season_IsNewOld=%s, Edit_Time=%s, Edit_Account=%s, Edit_Unitname=%s, Edit_Username=%s, Season_IsNew=%s, Season_IsCourseShow=%s, Season_IsPreCourse=%s, Season_IsFillStudent=%s, Season_IsFillTeacher=%s, Season_IsOnline=%s, Season_CastCourseStart=%s, Season_CastCourseEnd=%s, Season_ReviewStart=%s, Season_ReviewEnd=%s WHERE Season_ID=%s",
      ...
      <div align="center">
         ...
         <?php if ($totalRows_Cate > 0) { // Show if recordset not empty ?>
			...
			<select name="Season_IsNew" id="Season_IsNew" required> 
              		<option value="0" <?php if($row_Cate['Season_IsNew']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsNew']==1){echo 'selected';}?>>是</option>
              		</select>	
              		</td>	
                    <td class="FormTitle02" nowrap>前台課表顯示:</td>
                    <td class="middle">
              		<select name="Season_IsCourseShow" id="Season_IsCourseShow" required>
              		<option value="0" <?php if($row_Cate['Season_IsCourseShow']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsCourseShow']==1){echo 'selected';}?>>是</option>
              		</select>
                    </td>
                    </tr>
		    <tr>
			...
			<select name="Season_IsPreCourse" id="Season_IsPreCourse" required> 
              		<option value="0" <?php if($row_Cate['Season_IsPreCourse']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsPreCourse']==1){echo 'selected';}?>>是</option>
              		</select>	
              		</td>	
			...
			<select name="Season_IsFillStudent" id="Season_IsFillStudent" required> 
              		<option value="0" <?php if($row_Cate['Season_IsFillStudent']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsFillStudent']==1){echo 'selected';}?>>是</option>
              		</select>	
              		</td>	
                    <td class="FormTitle02" nowrap>講師問卷填寫:</td>
                    <td class="middle">
              		<select name="Season_IsFillTeacher" id="Season_IsFillTeacher" required>
              		<option value="0" <?php if($row_Cate['Season_IsFillTeacher']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsFillTeacher']==1){echo 'selected';}?>>是</option>
              		</select>
                    </td>
                    </tr>
                   <tr>
			...
			<select name="Season_IsOnline" id="Season_IsOnline" required> 
              		<option value="0" <?php if($row_Cate['Season_IsOnline']==0){echo 'selected';}?>>否</option>
              		<option value="1" <?php if($row_Cate['Season_IsOnline']==1){echo 'selected';}?>>是</option>
              		</select>	
              		</td>	
				...
				<table cellpadding="5" cellspacing="0" border="0">
                                  ...
                                  <div class="CastCourse_Add">
                                          <div class="DateStyle">
                                                <div class='input-group date picker_date' >
                                                <input type='text' name="Season_CastCourseStartDate" id="Season_CastCourseStartDate" data-format="yyyy/MM/dd" value="<?php if($row_Cate['Season_CastCourseStart']<>""){echo date("Y-m-d",strtotime($row_Cate['Season_CastCourseStart']));}?>" class="form-control" required/>
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                                </div>
                                          ...
                                          <div style="display:inline-block;">
                                               <div class="DateStyle">
                                                    <div class='input-group date picker_date' >
                                                    <input name="Season_CastCourseEndDate" type="text" id="Season_CastCourseEndDate"  data-format="yyyy/MM/dd hh:mm:ss" value="<?php if($row_Cate['Season_CastCourseEnd']<>""){echo date("Y-m-d",strtotime($row_Cate['Season_CastCourseEnd']));}?>" class="form-control" required/>
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                    </div>
                                  ...
                                  <div class="Review_Add">
                                          <div class="DateStyle">
                                                <div class='input-group date picker_date' >
                                                <input type='text' name="Season_ReviewStartDate" id="Season_ReviewStartDate" data-format="yyyy/MM/dd" value="<?php if($row_Cate['Season_ReviewStart']<>""){echo date("Y-m-d",strtotime($row_Cate['Season_ReviewStart']));}?>" class="form-control" required/>
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                                </div>
                                          ...
                                          <div style="display:inline-block;">
                                               <div class="DateStyle">
                                                    <div class='input-group date picker_date' >
                                                    <input name="Season_ReviewEndDate" type="text" id="Season_ReviewEndDate"  data-format="yyyy/MM/dd hh:mm:ss" value="<?php if($row_Cate['Season_ReviewEnd']<>""){echo date("Y-m-d",strtotime($row_Cate['Season_ReviewEnd']));}?>" class="form-control" required/>
                                                    <span class="input-group-addon">
                                                        <span class="glyphicon glyphicon-calendar"></span>
                                                    </span>
                                                    </div>
