...
$totalRows_CateP = mysql_num_rows($CateP);
	...
	$updateSQL = sprintf("UPDATE course_kind SET CourseKind_Name=%s, CourseKind_Sort=%s, CourseKind_Code=%s, Edit_Time=%s, Edit_Account=%s, Edit_Unitname=%s, Edit_Username=%s WHERE CourseKind_ID=%s",
                       GetSQLValueString($_POST['Title'], "text"),
                       GetSQLValueString($_POST['CourseKind_Sort'], "int"),
                       GetSQLValueString($_POST['CourseKind_Code'], "text"),
  ...
  $PastContent=$row_CateP['CourseKind_ID']."/".$row_CateP['CourseKind_Name']."/".$row_CateP['CourseKind_Sort']."/".$row_CateP['CourseKind_Code']."/".$row_CateP['Add_Time']."/".$row_CateP['Add_Account']."/".$row_CateP['Add_Unitname']."/".$row_CateP['Add_Username']."/".$row_CateP['Edit_Time']."/".$row_CateP['Edit_Account']."/".$row_CateP['Edit_Unitname']."/".$row_CateP['Edit_Username'];
  
  $NewContent=$_POST['ID']."/".$_POST['Title']."/".$_POST['CourseKind_Code']."/".$_POST['CourseKind_Sort']."/".$row_CateP['Add_Time']."/".$row_CateP['Add_Account']."/".$row_CateP['Add_Unitname']."/".$row_CateP['Add_Username']."/".$EditTime."/".$_POST['Edit_Account']."/".$_POST['Edit_Unitname']."/".$_POST['Edit_Username'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Form_Add")) {
	...
	$insertSQL = sprintf("INSERT INTO course_kind (Com_ID, CourseKind_Name, CourseKind_Sort, CourseKind_Code,Add_Time, Add_Account, Add_Unitname, Add_Username) VALUES (%s, %s, %s, %s, %s, %s ,%s ,%s)",
	...
	$NewContent=$_POST['Com_ID'].'/'.$_POST['Title']."/".$_POST['CourseKind_Sort']."/".$_POST['CourseKind_Code']."/".$AddTime."/".$_POST['Add_Account']."/".$_POST['Add_Unitname']."/".$_POST['Add_Username'];
      ...
      <form ACTION="<?php echo $editFormAction; ?>" name="Form_Add" id="Form_Add" method="POST">
        <div align="center">
          <fieldset style="max-width:1500px;">
              ...
              代碼：<input name="CourseKind_Code" type="text" id="CourseKind_Code" required>
              </span>
			...
			<?php do { ?>
             <form name="form_Edit" id="form_Edit" method="POST" action="<?php echo $editFormAction; ?>">
              ...
              <td class="middle">				
                ...
                <td class="middle"><input name="CourseKind_Code" type="text" id="CourseKind_Code" value="<?php echo $row_Cate['CourseKind_Code']; ?>" required></td>
                <?php if ($row_AdminMember['Unit_Range'] >= 2) { ?>
                ...
                <td class="middle">
                  <?php if($row_Permission['Per_Edit'] == 1){ ?>
                      ...
                      <input type="button" value="子目錄" class="Button_Edit" onclick="location.href='AD_Kind_Index.php?ID=<?php echo  $row_Cate['CourseKind_ID']; ?>';">
