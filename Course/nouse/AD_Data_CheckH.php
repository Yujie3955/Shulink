...
mysql_select_db($database_dbline, $dbline);
$query_Data = sprintf("SELECT * FROM courseteacher_list_h WHERE CourseTeacher_Pass=%s And ifnull(Season_Code,'') Like %s and (ifnull(CourseTeacher_Name,'') Like %s) and ifnull(Com_ID,'') like %s and ifnull(Unit_ID,'') like %s ORDER BY courseteacher_list_h.Season_Code DESC, Add_Time DESC",GetSQLValueString($colname05_Data, "text"),GetSQLValueString($colname02_Data, "text"),GetSQLValueString($colname03_Data, "text"), GetSQLValueString($colname03_Unit, "text"), GetSQLValueString($colname04_Data, "text"));
...
<div>   
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td>
<div class="SubTitle"><img src="../../Icon/IconEdit.png" width="28" class="middle">歷史<?php echo $row_ModuleSet['ModuleSetting_Title']?>管理：教師投課<?php if(isset($_GET['Checks']) && $_GET['Checks']==0){echo '未審區';}elseif(isset($_GET['Checks']) && $_GET['Checks']==1){echo '審核通過';}elseif(isset($_GET['Checks']) && $_GET['Checks']==2){echo '保留區';}?></div>
