...
for($rows=0;$rows<$colname_Area;$rows++){ 
    ...
    echo "<tr>
	      <td nowrap='nowrap'>
		  第".($rows+1)."週
		  <input type='hidden' name='CourseTeacher_Schedule[]' id='CourseTeacher_Schedulea".$rows."' value='第".($rows+1)."週' size='3'  required>
		  </td>
		  <td>
		  ...
		  <td>
		  <input type='text' name='CourseTeacher_Schedule[]' id='CourseTeacher_Scheduleb".$rows."' style='width:100%;' value='".@$Schedule[$y]."' required>
		  </td>
