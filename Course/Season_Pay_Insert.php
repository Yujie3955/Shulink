...
if($totalRows_CateP2_5>0){
	do{	
		//優惠查詢是否新增
		mysql_select_db($database_dbline, $dbline);
		$query_CateP2_3 = sprintf("SELECT Pid FROM pay WHERE pay.Season_Code = %s and Com_ID=%s and P_Text=%s and P_Cate=%s", GetSQLValueString($_POST['Season_Code'], "int"), GetSQLValueString($_POST['Com_ID'], "int"),GetSQLValueString($row_CateP2_5['PR_Text'], "text"),GetSQLValueString($row_CateP2_5['PR_Cate'], "text"));
