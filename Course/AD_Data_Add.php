...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Form_Add")) {
	   ...
	   Add_Account, Add_Unitname,  Add_Username, Course_Cate, Course_Pass, 
           ...
           Course_PassTime, Course_Pic, Course_PicText, Course_Special, Course_SetNO) VALUES (%s, %s, %s, %s, %s,    %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s,    %s, %s, %s, %s, %s)",
...
<div class="SubTitle"><img src="../../Icon/IconEdit.png" width="28" class="middle"> 新增<?php echo $row_ModuleSet['ModuleSetting_SubName'];?></div>
    ...
    <?php if($totalRows_TableData>0){
		echo '<ol>';
				...
				<td>        
				<?php //echo $row_TableData['CourseText_Fields']; ?>
                ...
                <?php }else{
				//echo $row_TableData['CourseText_Fields'];
