...
mysql_select_db($database_dbline, $dbline);
$query_Data = sprintf("SELECT * from courseteacher_detail_h where CourseTeacher_ID=%s and Com_ID Like %s ",GetSQLValueString($colname_ID, "int"),GetSQLValueString($colname03_Unit, "text"));
