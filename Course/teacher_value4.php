...
if($totalRows_Area>0){
	if($colname_Area3<>'' && $colname_Area=='' && $colname_Area2==''){
		echo '
              <input id="Teacher_ID4" name="Teacher_ID4" type="hidden" value="'.$row_Area['Teacher_ID'].'">
			  <input id="Teacher_NameValue4" name="Teacher_NameValue4" value="'.$row_Area['Teacher_UserName']."(".$row_Area['Teacher_Identity'].")".'" type="hidden">';
	}
	else{
		 echo '<input id="Teacher_ID4" name="Teacher_ID4" type="hidden" value="'.$row_Area['Teacher_ID'].'">';
	}
}
else{
	echo '<input id="Teacher_ID4" name="Teacher_ID4" type="hidden">';
}
